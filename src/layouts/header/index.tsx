      ...
      <nav className='relative  px-4 md:px-7 w-full flex items-center justify-between py-4'>
        ...
        <div className='flex items-center gap-5'>
          ...
          <BaseDropdown
            ...
            items={[
              { label: 'Guest', onClick: () => openAuthModal('login', 'guest') },
              { label: 'Creator', onClick: () => openAuthModal('login', 'creator') },
              { label: 'Vendor', onClick: () => openAuthModal('login', 'vendor') },
            ]}
          />
          ...
          <button
            ...
            <img src='/assets/landing-page/menu.svg' alt='' className='min-w-6 h-6' />
          </button>
          <BaseSheet
            side='right'
            size='sm'
