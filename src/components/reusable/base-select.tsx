...
export function BaseSelect({ width = 165, defaultValue, placeholder, items }: ICustomSelectProps) {
  return (
    <Select>
      <SelectTrigger
        ...
        <SelectValue placeholder={placeholder} className='font-light font-input-mono' />
      </SelectTrigger>
