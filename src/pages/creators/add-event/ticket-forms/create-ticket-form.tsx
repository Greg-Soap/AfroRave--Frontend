...
import { BaseCheckbox, type IBaseCheckbox } from '@/components/reusable/base-checkbox'
...
export default function CreateTicketForm({
  ...
  async function onSubmit(values: z.infer<typeof ticketSchema>) {
    try {
      ...
      const ticketRequests = transformTicketsToCreateRequest(values, eventId)
  ...
  return (
    <TabContainer<z.infer<typeof ticketSchema>>
      ...
      <>
        ...
        <AddBtn
          onClick={() => setTickets((prev) => [...prev, { id: Date.now() + Math.random() }])}
          name='Ticket'
        />
        ...
        <div className='flex flex-col gap-4'>
          <div className='flex flex-col gap-1 font-sf-pro-display text-black'>
            ...
            <p className='text-sm font-light '>
              Add a personal touch to the confirmation email your ticket buyers receive after
              purchase
            </p>
          </div>
          ...
          <div className='flex flex-col gap-4'>
            ...
            <div className='flex items-end hap-2 md:gap-6'>
              <FormField form={form} name='email' label='EMAIL' className='max-w-[360px]'>
                {(field) => (
  ...
  return (
    <>
      ...
      <div className='flex flex-col gap-3.5'>
        ...
        <AddBtn name='Perks' onClick={() => setPerksCount((prev) => prev + 1)} />
      </div>
      ...
      <div className='flex flex-col gap-4'>
        ...
        <FormField form={form} name={`tickets.${idx}.allowResell`}>
          {(field) => (
            <BaseCheckbox
              data={checkboxData[1]}
              {...field}
...
const checkboxData: IBaseCheckbox[] = [
  ...
  {
    description: 'This option allows attendees to resell their tickets to other fans.',
