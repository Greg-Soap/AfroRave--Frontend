...
function RoleDescription({ role, description, className, login }: IRoles & { className?: string }) {
  ...
  return (
    <div
      className={cn(
        'w-full md:max-w-1/2 flex flex-col gap-5 md:pb-[290px] xs:pb-[10px]',
        className,
      )}>
      ...
      <Button
        ...
        className='max-w-[120px] h-10 rounded-[20px] font-sf-pro-text text-sm font-semibold px-[17px] py-[11px] uppercase'>
        Learn More
      </Button>
    </div>
  )
