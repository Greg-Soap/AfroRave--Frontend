...
export default function StandAloneModal({ id }: { id: number }) {
  return (
    <BaseModal
      removeCancel
...
function StandAloneModalHeader({ id }: { id: number }) {
  return (
    <div className="w-full flex items-center justify-between">
      ...
      <div className="flex items-center gap-2">
        ...
        >
          <Link to={getRoutePath("individual_event", { eventId: id })}>
            View Event Page
          </Link>
        </Button>
        <Button
        ...
        >
          <Link to={getRoutePath("edit_event", { eventId: id })}>
            Edit Event
          </Link>
        </Button>
      </div>
