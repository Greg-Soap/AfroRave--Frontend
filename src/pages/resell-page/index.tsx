...
function StepCard({
  ...
  return (
    <div className="flex flex-col items-center text-center">
      ...
      <p className="text-white font-sf-pro-text text-base font-normal">
        {description}
      </p>
    </div>
  );
  ...
  return (
    <div className="flex items-center space-x-4">
      ...
      <div>
        ...
        <p className="font-sf-pro-text text-[12px] max-w-[320px]">
          {description}
        </p>
      </div>
    </div>
      ...
      <div className="bg-transparent text-white min-h-screen  mx-auto w-full">
        ...
        <div className="max-w-[1400px] mx-auto py-16 px-4 sm:px-6 lg:px-8 pt-24">
          ...
          <section className="mb-24 text-center">
            <h2 className="text-3xl sm:text-[40px] font-bold mb-4">
