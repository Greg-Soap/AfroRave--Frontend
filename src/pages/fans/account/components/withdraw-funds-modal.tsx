        ...
        <BaseModal
            ...
            <div className='w-full flex flex-col gap-6 p-6'>
                ...
                <Button
                    ...
                    className='w-full h-12 bg-white hover:bg-white/90 text-deep-red font-sf-pro-display font-semibold rounded-lg disabled:opacity-50 disabled:cursor-not-allowed'>
                    Confirm
                </Button>
            </div>
        </BaseModal>
